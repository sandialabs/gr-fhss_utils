...
class qa_tagged_burst_to_pdu (gr_unittest.TestCase):
    ...
    def test_002_simple(self):
        ...
        new_burst_dict = pmt.dict_add(new_burst_dict, fhss_utils.PMTCONSTSTR__relative_frequency(),
                                      pmt.from_float(1e6 / 30.72e6)) # in [-1.0,1.0], not Hz
        new_burst_dict = pmt.dict_add(new_burst_dict, fhss_utils.PMTCONSTSTR__center_frequency(),
